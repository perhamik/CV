		...
		<div className={styles.social}>
			...
			<div className={styles.social__list}>
				{social.map((single, key) => {
					return (
						<a href={single.url} key={key} target="_blank" aria-label={single.network} className={styles.social__item}>
							<i data-type={single.network.toLowerCase()} className={styles.social__item__icon}></i>
						</a>
					)
				})}
			</div>
